...
{
    public class NUB_Surface_base : IParametricSurface
    {
        ...
        public NUB_Surface_base()
        {
        }

        public NUB_Surface_base(XYZ4[][] dataPoints, XYZ3[][] VTangents = null)
        {
            Calulate(dataPoints, VTangents);
        }

        public NUB_Surface_base(NUB_Curve[] UCurves)
        {
            Calulate(UCurves);
        }

        public virtual void Calulate(XYZ4[][] dataPoints, XYZ3[][] VTangents = null)
        {
        ...
        public virtual void Calulate(NUB_Curve[] vCurves)
        {
        ...
        public virtual Tuple<int, double, int, double> Param_Mapping(double u, double v)
        {
        ...
        public virtual XYZ4 P(double u, double v)
        {
        ...
        public virtual XYZ3 dV(double u, double v)
        {
            Tuple<int, double, int, double> mappedPara = Param_Mapping(u, v);
            int sIndexU = mappedPara.Item1;
            double localU = mappedPara.Item2;
            ...
            XYZ3 t = NUB_Curve.dU_Blending(localV, Nc, vControlPoints);

            return t;
        }

        public virtual XYZ3 dV2(double u, double v)
        {
            Tuple<int, double, int, double> mappedPara = Param_Mapping(u, v);
            int sIndexU = mappedPara.Item1;
            double localU = mappedPara.Item2;
            ...
            XYZ3 t = NUB_Curve.dU2_Blending(localV, Nc, vControlPoints);

            return t;
        }

        public virtual XYZ3 dU(double u, double v)
        {
            Tuple<int, double, int, double> mappedPara = Param_Mapping(u, v);
            int sIndexU = mappedPara.Item1;
            double localU = mappedPara.Item2;
        ...
        public virtual XYZ3 dU2(double u, double v)
        {
            Tuple<int, double, int, double> mappedPara = Param_Mapping(u, v);
            int sIndexU = mappedPara.Item1;
            double localU = mappedPara.Item2;
        ...
        public virtual XYZ3 dUdV(double u, double v)
        {
            Tuple<int, double, int, double> mappedPara = Param_Mapping(u, v);
            int sIndexU = mappedPara.Item1;
            double localU = mappedPara.Item2;
        ...
        public virtual XYZ3 N(double u, double v)
        {
            XYZ3 normal;
